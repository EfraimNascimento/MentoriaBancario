...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // ADICIONADO: Pega a referência do ícone dentro do botão
    ...
    if (menuToggle && sidebar && mainContent && menuIcon) {
        ...
        const closeSidebar = () => {
            ...
            // ADICIONADO: Garante que o ícone volte a ser 'barras' ao fechar
        ...
        menuToggle.addEventListener("click", () => {
            ...
            // ADICIONADO: Troca o ícone com base no estado do menu
            if (isSidebarActive) {
